...
function cardTemplate(def) {
  ...
  const [runBtn, urlBtn] = wrap.querySelectorAll('button');
  const inputs = {};
  ...
  // Evento Ayuda (ÚNICO Y CORREGIDO)
  urlBtn.addEventListener('click', () => {
    const mensajesAyuda = {
      github_user: "Escribe el nombre de usuario de GitHub para ver su perfil.",
      wttr: "Ingresa el nombre de la ciudad para ver su clima.",
